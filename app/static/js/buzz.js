...
//				console.log(source);
//				console.log(link);
				var output = "<div class='newsresult'><span><a href="+link+" target='_blank'><p class='newsTitle'>"+ title +"<img src='Images/nw.png' /></p></a></span><p class='newsSource'>"+ source +"</p></div>";
...
function build(videoId) {
	var url = "<iframe id='ytplayer' type='text/html' width='260px' height='200px'";
